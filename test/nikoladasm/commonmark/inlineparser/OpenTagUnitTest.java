...
public class OpenTagUnitTest {
	...
	public static Collection<Object[]> data() throws Exception {
		return Arrays.asList(new Object[][] {
			...
			{"<a href=\"\" onclick=\"_gaq.push(['_trackEvent', 'Category', 'Action', 'Extra Label if you like!']);\">"},
		});
	}
	...
	public void test() {
		...
		assertThat(((InlineHtmlNode) first).literal(), is(equalTo(input)));
	}
}

...
public class SecondChildInlineCodeSpanUnitTest {
	...
	public void test() {
		...
		dummyBlockNode.childs().removeFirst();
		Node second = dummyBlockNode.childs().getFirst();
		assertThat(second, instanceOf(InlineCodeNode.class));
		assertThat(((InlineCodeNode) second).literal(), is(equalTo(codeSpanLiteral)));
	}
